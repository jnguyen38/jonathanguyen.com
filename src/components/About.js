    ...
    const aboutData = [
        {
            ...
            content: [
                ...
                {type: "text", value: "Being from North Jersey, there aren't a lot of climbing gyms or outdoors spots near me, so this hobby really started once I got my driver's license. Before that, I always knew that I liked climbing, I just never had the chance to climb consistently. I remember my dad would take me to the gym once or twice a year when I was younger, and I would love playing around on the walls. Climbing gyms were always just huge playgrounds to me."},
                {type: "section", value: "How it's Going"},
                {type: "text", value: "Even though I don't get to climb as much anymore, climbing is still my favorite thing to do in my free time. I love the problem solving involved, the physicality, and the people that I meet wherever the sport takes me. Whether it's at my local gym, on real rock at The Powerlinez or the Red River Gorge, I know that I'll always find an amazing community of climbers."},
        ...
        },
        {
            ...
            content: [
                ...
                {type: "text", value: "I love my friends, especially my friends back at home. The group of 6 guys from home have been through thick and thin with me and I'm proud to call them my brothers. They're some of the closest friends I have in my life, if not the closest. I don't tell them how much I appreciate them enough, and with all of us being away at college now in days, I don't see them in person enough to show them."},
                {type: "subsection", value: "College"},
                {type: "text", value: "So far in college, I've met so many people that sometimes I forget who I've met and who I haven't. Anyway, aside from the people I forgot, I've been blessed to meet a handful of people that I won't forget."},
        ...
        },
        {
            ...
            content: [
                {type: "section", value: "How it Started"},
                {type: "text", value: "So, I used to always play ukulele. I knew all the classics, Somewhere Over the Rainbow, What a Wonderful World, and so on. One day my sister got mad that I was using her ukulele all the time and says \"Why don't you learn a real man's instrument?\". So, I picked up guitar. Ever since then I've been playing."},
                {type: "text", value: "I started with some Ed Sheeran. I learned most of his songs then went into learning more difficult John Mayer finger-style percussive patterns. Now in days, I like more of a Noah Kahan or Lumineers related genre."},
                {type: "section", value: "How it's Going"},
                {type: "text", value: "Even though I still love playing, I usually don't find enough time in the day to sit down and practice. That extra free time only really comes late at night or during breaks. When I do get a chance to play, I love going back and playing some of the earlier songs I learned. I even try my hand at my own music every now and then (album dropping soon)."}
            ]
        },
        {
            ...
            content: [
                {type: "section", value: "How it Started"},
                {type: "text", value: "My work with photography really only started during my senior year of high school, just before the COVID pandemic hit the US. I was one of the class photographers and really took pride in my work along the way. Not only did I love taking pictures for my friends and brainstorming creative senior portraits, but I was also able to use photography as a means to get to know some of my classmates who I otherwise didn't really talk to. While I don't consider myself an amazing photographer, I ended up really enjoying photography, decided to learn more about it, and took it with me to college. Now I mainly just take pictures of landscapes and for my friends whenever I go on a trip. While I was in Europe studying abroad in the summer of 2022, I really got to dive head first into improving my photography skills."},
                {type: "section", value: "My Work"},
                {type: "subsection", value: "Landscape"},
                {type: "text", value: "I don't have a portfolio or anything because photography is more of a hobby than anything else, but here are two of my favorite pictures that I took while I was in the UK back in 2022. This first one is just a picture of a street in London from the perspective of one of those Big Red Buses. It was taken right before the Queen's Platinum Jubilee (70th anniversary of her coronation)."},
                ...
                {type: "text", value: "In addition to landscape photography, I recently started experimenting with hyperlapses at Notre Dame. I think the idea of a hyperlapse is really cool, but the execution was a lot harder than I initially thought. Here was my first attempt at a freehand hyperlapse. Even after some editing, the result is pretty shaky, but I was really happy with the result, and I didn't think it was bad for my first attempt."},
                {type: "image", value: dome, AR: styles.profileAR, dim: styles.aboutDim},
            ]
        },
        {
            size: styles.side, id: 4, type: "Travel", name: "Life Updates", src: paraglidingGroup,
    ...
    return (
        <div id={`about`} className={`${styles.about} gap-2`}>
            ...
            <p className={`${styles.description} fw-2 fs-sm`}>
                If you knew me, you would know I love doing some things in particular: rock <span className={`fw-5`}>climbing</span>,
                playing <span className={`fw-5`}>guitar</span>, and <span className={`fw-5`}>photography</span>. Obviously, I also
                cherish the time I get to spend with close <span className={`fw-5`}>family and friends</span>.
                My writing is a little drawn out, but feel free to
